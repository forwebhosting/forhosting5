...
import { photosPage, followersPage, recentlyviewedPage, bookmarksPage, blogpostsPage, orderhistoryPage, myaddressPage, favoriteordersPage, bookingsPage} from '../../../helpers/constants'
...
let UserProfileRightsideBar = () => {
    ...
    let data = [{
        imgSrc: ImgSrc,
        title: "Habeeb Biryani",
        address: "EastGate, Tnj",
        stars: 5,
        days: 10,
        votes: 10,
        comments: 2,
